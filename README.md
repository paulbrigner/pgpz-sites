...
| --- | --- | --- |
| [`apps/community`](apps/community/README.md) | Public/member Community site | X and ZcashMe social-proof membership, X Monitor, ZEC Shelf |
...
| [`apps/board`](apps/board/README.md) | Private Board governance portal | Required passkeys, recovery magic links, scoped roles, document vault, audit ledger |
