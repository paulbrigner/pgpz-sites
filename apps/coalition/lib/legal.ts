...
export const privacyDocument: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "We collect information you provide directly, such as your first and last name, corporate affiliation, job title, policy interest groups, LinkedIn URL, X handle, email address, account records, coalition materials, messages, support requests, and preferences.",
