...
describe("buildPolicyUpdateForumMarkdown", () => {
  it("exports clean forum markdown with public email asset images", () => {
    ...
    expect(markdown).toContain(
      "[![Josh Swihart X post screenshot](https://coalition.pgpz.org/api/policy-updates/2026-06-15-weekly-policy-memo/email-assets/x-josh-swihart.png)](https://x.com/jswihart/status/2066384781601132602?s=20)",
    );
  ...
  it("renders relevant posts as a subsection without inheriting section links", () => {
    ...
    expect(markdown).toContain(
      "![Relevant post screenshot from page 3](https://coalition.pgpz.org/api/policy-updates/2026-06-15-weekly-policy-memo/email-assets/relevant-post-page-3-1.png)",
    );
    expect(markdown).not.toContain(
      "[![Relevant post screenshot from page 3](https://coalition.pgpz.org/api/policy-updates/2026-06-15-weekly-policy-memo/email-assets/relevant-post-page-3-1.png)](https://example.com/article)",
    );
  });
  ...
  it("links known June 22 relevant post screenshots in markdown exports", () => {
    ...
    expect(markdown).toContain(
      "[![Relevant post screenshot from page 5](https://coalition.pgpz.org/api/policy-updates/2026-06-22-weekly-policy-memo/email-assets/relevant-post-page-5-1.png)](https://x.com/CharlesFLehman/status/2067963794836349321)",
    );
  });
});
