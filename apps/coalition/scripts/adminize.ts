 ...
 *
 * Usage:
 *   NEXTAUTH_TABLE=PGPZCoalitionNextAuth REGION_AWS=us-east-1 npx tsx scripts/adminize.ts user@example.com
 *   NEXTAUTH_TABLE=PGPZCoalitionNextAuth REGION_AWS=us-east-1 npx tsx scripts/adminize.ts user@example.com --unset
 */
import { DynamoDBClient } from "@aws-sdk/client-dynamodb";
import { DynamoDBDocument } from "@aws-sdk/lib-dynamodb";

const REGION = process.env.REGION_AWS || process.env.AWS_REGION || "us-east-1";
const TABLE_NAME = process.env.NEXTAUTH_TABLE || "PGPZCoalitionNextAuth";
