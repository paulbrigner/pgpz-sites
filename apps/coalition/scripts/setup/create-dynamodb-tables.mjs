#!/usr/bin/env node
/**
 * Create the DynamoDB table used by NextAuth and PGPZ Coalition records.
 *
 * Usage:
 ...
 *     --region us-east-1 \
 *     --nextauth-table PGPZCoalitionNextAuth
 */
import {
  CreateTableCommand,
...
let nextAuthTable = process.env.NEXTAUTH_TABLE || "PGPZCoalitionNextAuth";
let skipTtl = false;
