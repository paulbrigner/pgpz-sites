...
export async function GET(_request: NextRequest, { params }: Props) {
  ...
  return new NextResponse(
    htmlPage(
      ...
      alreadyUnsubscribed
        ? "This email address is already suppressed for future PGPZ Coalition member emails. Your coalition account and member access are unchanged."
        : "Confirm that you want to stop future PGPZ Coalition member emails. Your coalition account and member access will remain unchanged.",
      !alreadyUnsubscribed,
    ),
    {
      headers: { "Content-Type": "text/html; charset=utf-8", "Cache-Control": "no-store" },
...
export async function POST(request: NextRequest, { params }: Props) {
  ...
  return new NextResponse(
    htmlPage(
      ...
      "This email address has been suppressed for future PGPZ Coalition member emails. Your coalition account and member access are unchanged.",
    ),
    {
      headers: { "Content-Type": "text/html; charset=utf-8", "Cache-Control": "no-store" },
    },
