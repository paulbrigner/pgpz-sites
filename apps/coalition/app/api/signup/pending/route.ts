  ...
  try {
    ...
    await documentClient.put({
      ...
      Item: {
        ...
        memberDirectoryPreferenceSource: "signup",
        memberDirectoryPreferenceUpdatedAt: now,
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const updateParts = [
      ...
      "memberDirectoryPreferenceSource = :memberDirectoryPreferenceSource",
      "memberDirectoryPreferenceUpdatedAt = :memberDirectoryPreferenceUpdatedAt",
    ...
    const values: Record<string, unknown> = {
      ...
      ":memberDirectoryOptIn": memberDirectoryOptIn,
      ":memberDirectoryPreferenceSource": "signup",
      ":memberDirectoryPreferenceUpdatedAt": new Date().toISOString(),
      ":policyInterestGroups": policyInterestGroups,
