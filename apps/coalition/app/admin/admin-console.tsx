...
import { Activity, Inbox, Mail, Newspaper, Users } from "lucide-react";
...
type AdminTab = "users" | "resources" | "updates" | "newsletters" | "access";
...
const tabs: Array<{
...
}> = [
  {
    ...
    description: "Approve or reject member submissions",
    icon: Inbox,
  },
  {
    id: "users",
