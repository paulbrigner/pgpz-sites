...
export const metadata = {
  title: "PGPZ Coalition | Pretty Good Policy",
  description: "The Pretty Good Policy partner workspace for policy resources, messaging, and coalition campaigns.",
};
            ...
            <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
              <div className="space-y-4">
                <a
                  ...
                  aria-label="Pretty Good Policy Coalition logo; visit the official Zcash website"
                ...
                >
                  <Image
                    ...
                    alt="Pretty Good Policy Coalition"
                    width={1578}
                    height={750}
