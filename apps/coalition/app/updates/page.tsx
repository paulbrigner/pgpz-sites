...
export const metadata = {
  title: "Policy Updates | PGPZ Coalition",
};
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm leading-6 text-slate-600">
              Weekly policy memos and special updates are available to active PGPZ Coalition members.
        ...
        <div className="coalition-hero__frame">
          <div className="max-w-3xl space-y-5">
            ...
            <h1 className="text-4xl font-semibold leading-tight sm:text-5xl">
              Weekly memos and special updates for PGPZ Coalition members.
            </h1>
