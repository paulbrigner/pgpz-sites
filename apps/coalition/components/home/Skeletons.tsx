...
export function HomeShellSkeleton() {
  return (
    <div className="relative mx-auto w-full max-w-6xl space-y-12 px-4 md:px-6 animate-pulse">
      <section className="coalition-hero p-8 md:p-12">
        <div className="coalition-hero__frame">
          <div className="coalition-hero__content mx-auto flex w-full max-w-4xl flex-col items-center gap-8 text-center md:flex-row md:items-stretch md:gap-12 md:text-left">
            ...
            <div className="mx-auto flex-shrink-0 rounded-[1.9rem] border border-[rgba(47,111,104,0.28)] bg-white/10 p-[6px] shadow-[0_28px_48px_-28px_rgba(30,30,30,0.42)] backdrop-blur-lg md:mx-0 md:self-center">
