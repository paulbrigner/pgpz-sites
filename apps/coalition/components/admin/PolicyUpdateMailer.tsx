                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedUpdate?.slug === update.slug
                      ? "border-[rgba(47,111,104,0.72)] bg-[var(--brand-ice)]"
        ...
        <div className="rounded-2xl border bg-white/90 p-5">
          {selectedUpdate ? (
            <div className="space-y-5">
                ...
                <div className="mt-4 grid gap-2 sm:grid-cols-2">
                  <button
                    ...
                    className={cn(
                      ...
                      audienceMode === "all_active_members"
                        ? "border-[rgba(47,111,104,0.62)] bg-white shadow-sm"
              ...
              <label className="flex items-start gap-3 rounded-xl border border-[rgba(47,111,104,0.32)] bg-[var(--brand-ice)] p-4 text-sm leading-6 text-slate-700">
                <input
                  type="checkbox"
                  className="mt-1 h-4 w-4"
                  checked={confirmSend}
