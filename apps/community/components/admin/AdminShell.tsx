  ...
  return (
    <AdminSensitiveDataProvider>
      <div className="mx-auto max-w-6xl space-y-6 px-5 pb-14">
        <div className="glass-surface relative overflow-hidden border border-[rgba(71,85,105,0.28)] bg-white/85 p-6 shadow-[0_26px_46px_-26px_rgba(30,30,30,0.32)]">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col items-start gap-2 sm:items-end">
              <div className="inline-flex items-center gap-2 rounded-full border border-[rgba(71,85,105,0.42)] bg-[rgba(71,85,105,0.12)] px-4 py-2 text-[0.9rem] font-semibold text-[var(--brand-denim)] shadow-[0_10px_30px_-18px_rgba(30,30,30,0.35)]">
