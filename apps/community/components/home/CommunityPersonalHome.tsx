...
export function CommunityPersonalHome({
  ...
  const latestUpdateType = latestUpdate?.categoryLabel.trim().toLowerCase() || "policy update";
  ...
  return (
    <PersonalHome aria-label="Your PGPZ Community home">
      ...
      <PersonalHomeGrid>
        <PersonalHomeColumn className="lg:col-span-7">
          <PersonalHomePanel
            eyebrow="Recommended next"
            title={`Start with the latest ${latestUpdateType}`}
            description={`The newest ${latestUpdateType} is your fastest route into the current policy conversation.`}
            className="community-personal-home__panel"
          >
            {latestUpdate ? (
          ...
          <PersonalHomePanel
            ...
            description="Return to the other current member update when you are ready."
            className="community-personal-home__panel"
            action={(
        ...
        <PersonalHomeColumn className="lg:col-span-5">
          <PersonalHomePanel
