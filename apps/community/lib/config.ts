...
export const PRIVATE_KEY_SECRET_ARN = process.env
  .NEXT_PUBLIC_PRIVATE_KEY_SECRET_ARN as string;
export const CLOUDFRONT_DOMAIN = process.env
  .NEXT_PUBLIC_CLOUDFRONT_DOMAIN as string;
...
export const NEXTAUTH_SECRET = process.env
  .NEXT_PUBLIC_NEXTAUTH_SECRET as string;
