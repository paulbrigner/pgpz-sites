...
export const COMMUNITY_ZEC_SHELF_CLIENT_CONFIG = {
  ...
  theme: {
    ...
    accent: "#F5A800",
    accentSoft: "#FFE6A3",
    accentSubtle: "rgba(71, 85, 105, 0.14)",
    accentText: "#475569",
    ice: "#F6FAF2",
    teal: "#2F6F68",
    surface: "linear-gradient(135deg, rgba(230, 234, 240, 0.64), rgba(255, 255, 255, 0.92))",
    focusRing: "rgba(245, 168, 0, 0.24)",
    overlay: "rgba(13, 31, 32, 0.76)",
    heroBackground: "linear-gradient(125deg, #0D1F20 0%, #163130 48%, #475569 100%)",
    heroBorder: "rgba(71, 85, 105, 0.42)",
  },
