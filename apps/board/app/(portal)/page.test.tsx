...
describe("board dashboard", () => {
  it("greets the signed-in director without exposing disabled features", () => {
    render(<BoardDashboard member={{ name: "Ada Director", email: "ada@example.org", role: "member", isAdmin: false }} />);
  ...
  it("shows the enforced administration surface only to administrators", () => {
    render(<BoardDashboard member={{ name: "Grace Admin", email: "grace@example.org", role: "admin", isAdmin: true }} />);
  ...
  it("shows the Executive Director badge instead of director badges for staff", () => {
    render(<BoardDashboard member={{ name: "Div Staff", email: "div@example.org", role: "executive-director", isAdmin: true }} />);
