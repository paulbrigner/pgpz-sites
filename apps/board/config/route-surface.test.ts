...
describe("private board feature surface", () => {
  ...
  it("exposes only sign-in anonymously and keeps administration server-rendered", () => {
    ...
    expect(existsSync(path.join(appRoot, "(portal)", "governance-safeguards", "page.tsx"))).toBe(true);
  ...
  it("exposes only the Better Auth, administration, document vault, disclosures, agenda ideas, and meeting API routes", () => {
    ...
    expect(routes.sort()).toEqual([
      ...
      "api/agenda-ideas/route.ts",
      "api/better-auth/[...all]/route.ts",
      "api/documents/[id]/download/route.ts",
      "api/documents/local-upload/[operationId]/route.ts",
      "api/documents/route.ts",
      "api/meetings/[id]/materials/route.ts",
      "api/meetings/[id]/notifications/route.ts",
      "api/disclosures/route.ts",
      "api/disclosures/[id]/route.ts",
      "api/disclosures/[id]/record/route.ts",
      "api/disclosures/[id]/policy/route.ts",
      "api/disclosures/[id]/reminder/route.ts",
      "api/meetings/[id]/calendar/route.ts",
      "api/meetings/[id]/ballots/[ballotId]/packet/route.ts",
      "api/meetings/[id]/ballots/[ballotId]/record/route.ts",
      "api/meetings/[id]/ballots/[ballotId]/review-record/route.ts",
      "api/meetings/[id]/ballots/route.ts",
      "api/meetings/[id]/communications/route.ts",
      "api/meetings/[id]/discussions/route.ts",
      "api/meetings/[id]/executive-sessions/[sessionId]/materials/[materialId]/route.ts",
      "api/meetings/[id]/executive-sessions/[sessionId]/materials/route.ts",
      "api/meetings/[id]/executive-sessions/[sessionId]/route.ts",
      "api/meetings/[id]/executive-sessions/route.ts",
