...
type SignupNotificationsPanelDependencies = {
...
export function createSignupNotificationsPanel({ Button }: SignupNotificationsPanelDependencies) {
return function SignupNotificationsPanel() {
