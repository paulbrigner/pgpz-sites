...
type AccessLogPanelDependencies = {
  Button: ComponentType<any>;
  Link: ComponentType<{ className?: string; href: string; children: ReactNode }>;
  SensitiveDataText: ComponentType<{
...
export function createAccessLogPanel({
  Button,
  Link,
  SensitiveDataText,
  cn,
}: AccessLogPanelDependencies) {
return function AccessLogPanel() {
    ...
    <div className="space-y-5">
      ...
      {meta && !meta.complete ? (
        <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
          Totals are incomplete because the 30-day query exceeded the safety page limit.
        </div>
      ) : null}
