...
import { createPublicFileLibraryPanel } from "./PublicFileLibraryPanel";

const Button = ({ isLoading: _isLoading, ...props }: any) => <button {...props} />;
const PublicFileLibraryPanel = createPublicFileLibraryPanel({
  Button,
