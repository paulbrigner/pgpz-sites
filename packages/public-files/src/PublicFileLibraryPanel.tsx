...
type PublicFileLibraryPanelDependencies = {
...
export function createPublicFileLibraryPanel({
  Button,
  cn,
}: PublicFileLibraryPanelDependencies) {
  return function PublicFileLibraryPanel() {
