...
| --- | --- | --- | --- |
| Community | Better Auth magic link plus X and ZcashMe social proof | X Monitor, Topic Briefings, ZEC Shelf, referrals | Community table/buckets/queue/compute role |
...
| Board | Required user-verified Better Auth passkeys plus single-use magic-link onboarding and controlled recovery | role-scoped governance documents, upcoming/past meetings, individual disclosures with restricted review, manual communications, audit review, and access management | Board auth, access, meeting, document, audit, and storage resources |
